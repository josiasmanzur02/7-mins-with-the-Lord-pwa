const translations = {
  en: {
    ...
    settings_alarm_hint:
      'Best effort while the app is open. Notifications depend on browser permission. iOS PWAs cannot ring in the background.',
    ...
    settings_backup_desc: 'Everything is stored on this device. Export/import to move streak and settings.',
    ...
    install_offline:
      'You can also use the app offline; it will sync your streak the next time you’re online.',
    ...
    timer_wait_note:
      'Please wait. Next section: {{label}} starts after this {{seconds}}-second countdown.',
  ...
  es: {
    ...
    settings_alarm_hint:
      'Mejor esfuerzo mientras la app está abierta. Las notificaciones dependen del permiso del navegador. Las PWA en iOS no pueden sonar en segundo plano.',
    ...
    settings_backup_desc:
      'Todo se guarda en este dispositivo. Exporta/importa para mover la racha y los ajustes.',
    settings_feedback: 'Comentarios',
    settings_feedback_desc:
      '¿Encontraste un error o tienes una sugerencia? Escribe a manzur.josias@gmail.com.',
    ...
    install_offline:
      'También puedes usar la app sin conexión; se sincronizará cuando vuelvas a estar en línea.',
    ...
    timer_wait_note:
      'Espera por favor. Siguiente sección: {{label}} empieza después de esta cuenta regresiva de {{seconds}} segundos.',
...
function getSteps(lang) {
  return [
    { key: 'calling', label: translate(lang, 'step_calling'), seconds: 30 },
    { key: 'pray', label: translate(lang, 'step_pray'), seconds: 60 },
    { key: 'pray-read', label: translate(lang, 'step_pray_read'), seconds: 150 },
    { key: 'confession', label: translate(lang, 'step_confession'), seconds: 60 },
    { key: 'consecration', label: translate(lang, 'step_consecration'), seconds: 30 },
    { key: 'thanks', label: translate(lang, 'step_thanks'), seconds: 30 },
    { key: 'petition', label: translate(lang, 'step_petition'), seconds: 60 },
  ];
}
